	...
	<tr>
	  ...
	  <td width="651" valign="top"><div><img src="images/spacer.gif" width="1" height="3" border="0" alt=""></div>
		  <table border="0" cellpadding="0" cellspacing="0"  style="background: url(images/left_bg.gif)">
				<tr>
					...
					<td width="647"><div class="lb">PRODUCTS LIST</div> <div class="lw">PRODUCTS LIST</div></td>
	  ...
	  <?php 
                                ...
                                <table border="0" cellpadding="0" cellspacing="15">
									<tr>
										<td width="200" align="center"><a href="#"><img src="images/img<?php echo rand(1,4);?>.jpg" width="79" height="66" border="0" alt=""></a></td>
										<td width="400">
											<div class="item_name"><?php echo $row['ProductName']; ?></div>
											<div class="item_desc"></div>
											<div class="item_price"><span class="top11">price:</span> Rs. <?php echo $row['ProductPrice']; ?></div>
											<div style="padding-bottom: 5px">
                                            <?php if(isset($_SESSION['username'])){?>
                                            <form action="functions.php" method="post">
                                            <input type="image" src="images/cart.gif" alt="Add To Cart">
                                            <input type="hidden" name="var" value="AddToCart">
...
<table border="0" cellpadding="0" cellspacing="0" width="647" align="center">
	<tr>
		...
		<td align="right" valign="top"><div class="top11">Copyright © 2012 Company Name <b>XYZ.com<a href="#" class="top11"></a></b><br>
		</div></td>
	</tr>
</table>
